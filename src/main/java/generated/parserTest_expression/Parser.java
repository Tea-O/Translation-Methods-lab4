package generated.parserTest_expression;
...
public class Parser {
    ...
    public PowerS powerS(double acc) {
    ...
    public LeftE leftE() {
        ...
        switch(token.typeToken()) {
            case NUM -> {
                ...
                res.addChild(token.text());
                nextToken();
                 res.val = Double.parseDouble(NUM0); 
            }
            case OPEN -> {
